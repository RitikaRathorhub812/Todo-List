  ...
  if(mainTask.length>0){
    renderTask = mainTask.map((t,i) =>{
      ...
      onClick={() => {
       ...
       className='bg-green-500 text-white px-4 py-2 rounded font-bold'>Delete</button>
      </li> 
...
return (
   ...
   /* fregments*/
   <>
   <h1 className='bg-black text-white p-5 text-2xl font-bold text-center'>My TodoList</h1>
